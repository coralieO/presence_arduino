<template>
  <div class=" ">
    ...
    <div class="bg-slate-100 px-12 pt-3">
      ...
      <div
        v-if="New"
        class="p-4 mb-4 text-sm text-green-800 rounded-lg bg-green-100"
        role="alert"
      >
...
export default defineComponent({
  ...
  setup() {
    ...
    const evtSource = new EventSource(
      "https://iot-m2-card.onrender.com/sse/1",
      {
    ...
    evtSource.onmessage = (event) => {
      ...
      msg.text = "Bienvenue " + ParseJson.data.user.name;
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          "https://iot-m2-card.onrender.com/rooms/1"
        );
